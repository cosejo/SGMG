...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'SGGITIPOIMPLEMENTO'.
	/// </summary>
	public class cSGGITIPOIMPLEMENTONegocios : cSGGITIPOIMPLEMENTODatos
	{
		...
		/// </summary>
		public cSGGITIPOIMPLEMENTONegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
