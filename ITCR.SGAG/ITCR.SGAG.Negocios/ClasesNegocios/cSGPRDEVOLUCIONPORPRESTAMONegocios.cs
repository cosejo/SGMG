...
// Proyecto: ITCR.SGAG
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'SGPRDEVOLUCIONPORPRESTAMO'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'SGPRDEVOLUCIONPORPRESTAMO'.
	/// </summary>
	public class cSGPRDEVOLUCIONPORPRESTAMONegocios : cSGPRDEVOLUCIONPORPRESTAMODatos
	{
		...
		/// </summary>
		public cSGPRDEVOLUCIONPORPRESTAMONegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cSGPRDEVOLUCIONPORPRESTAMO;"
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cSGPRDEVOLUCIONPORPRESTAMO;"+ex.Message;
