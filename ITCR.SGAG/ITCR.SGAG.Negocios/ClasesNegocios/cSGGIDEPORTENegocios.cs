...
// Proyecto: ITCR.SGAG
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'SGGIDEPORTE'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'SGGIDEPORTE'.
	/// </summary>
	public class cSGGIDEPORTENegocios : cSGGIDEPORTEDatos
	{
		...
		/// </summary>
		public cSGGIDEPORTENegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cSGGIDEPORTE;"
					+"ID_DEPORTE:"+ID_DEPORTE.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cSGGIDEPORTE;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
