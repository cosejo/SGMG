...
// Proyecto: ITCR.SGAG
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'SGMUPERMISOSPORTIPOUSUARIO'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'SGMUPERMISOSPORTIPOUSUARIO'.
	/// </summary>
	public class cSGMUPERMISOSPORTIPOUSUARIONegocios : cSGMUPERMISOSPORTIPOUSUARIODatos
	{
		...
		/// </summary>
		public cSGMUPERMISOSPORTIPOUSUARIONegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cSGMUPERMISOSPORTIPOUSUARIO;"
					+"FK_IDPERMISO:"+FK_IDPERMISO.ToString()+";"
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cSGMUPERMISOSPORTIPOUSUARIO;"+ex.Message;
