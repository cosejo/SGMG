...
// Proyecto: ITCR.SGAG
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'SGPRTIPOPRESTAMO'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'SGPRTIPOPRESTAMO'.
	/// </summary>
	public class cSGPRTIPOPRESTAMONegocios : cSGPRTIPOPRESTAMODatos
	{
		...
		/// </summary>
		public cSGPRTIPOPRESTAMONegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cSGPRTIPOPRESTAMO;"
					+"NOM_PRESTAMO:"+NOM_PRESTAMO.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cSGPRTIPOPRESTAMO;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cSGPRTIPOPRESTAMO;"
					+"ID_TIPOPRESTAMO:"+ID_TIPOPRESTAMO.ToString()+";"
					+"NOM_PRESTAMO:"+NOM_PRESTAMO.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cSGPRTIPOPRESTAMO;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cSGPRTIPOPRESTAMO;"
					+"ID_TIPOPRESTAMO:"+ID_TIPOPRESTAMO.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cSGPRTIPOPRESTAMO;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
