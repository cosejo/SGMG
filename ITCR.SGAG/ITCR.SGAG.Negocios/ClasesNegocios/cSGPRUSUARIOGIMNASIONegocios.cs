...
// Proyecto: ITCR.SGAG
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'SGPRUSUARIOGIMNASIO'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'SGPRUSUARIOGIMNASIO'.
	/// </summary>
	public class cSGPRUSUARIOGIMNASIONegocios : cSGPRUSUARIOGIMNASIODatos
	{
		...
		/// </summary>
		public cSGPRUSUARIOGIMNASIONegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cSGPRUSUARIOGIMNASIO;"
					+"CAR_USUARIOGIMNASIO:"+CAR_USUARIOGIMNASIO.ToString()+";"
					+"NOM_USUARIOGIMNASIO:"+NOM_USUARIOGIMNASIO.ToString()+";"
					+"APE_USUARIOGIMNASIO:"+APE_USUARIOGIMNASIO.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cSGPRUSUARIOGIMNASIO;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cSGPRUSUARIOGIMNASIO;"
					+"CAR_USUARIOGIMNASIO:"+CAR_USUARIOGIMNASIO.ToString()+";"
					+"NOM_USUARIOGIMNASIO:"+NOM_USUARIOGIMNASIO.ToString()+";"
					+"APE_USUARIOGIMNASIO:"+APE_USUARIOGIMNASIO.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cSGPRUSUARIOGIMNASIO;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
