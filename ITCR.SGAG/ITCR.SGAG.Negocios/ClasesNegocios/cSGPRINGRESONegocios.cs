...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'SGPRINGRESO'.
	/// </summary>
	public class cSGPRINGRESONegocios : cSGPRINGRESODatos
	{
		...
		/// </summary>
		public cSGPRINGRESONegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cSGPRINGRESO;"
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cSGPRINGRESO;"
