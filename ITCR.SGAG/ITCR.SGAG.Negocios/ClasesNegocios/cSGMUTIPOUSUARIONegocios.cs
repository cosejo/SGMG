...
// Proyecto: ITCR.SGAG
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'SGMUTIPOUSUARIO'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'SGMUTIPOUSUARIO'.
	/// </summary>
	public class cSGMUTIPOUSUARIONegocios : cSGMUTIPOUSUARIODatos
	{
		...
		/// </summary>
		public cSGMUTIPOUSUARIONegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		/// <UL>
		///		 <LI>NOM_TIPOUSUARIO</LI>
		/// </UL>
		/// Propiedades actualizadas luego de una llamada exitosa a este método: 
		/// <UL>
		///		 <LI>ID_TIPOUSUARIO</LI>
		///		 <LI>CodError</LI>
		/// </UL>
		/// </remarks>
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cSGMUTIPOUSUARIO;"
					+"NOM_TIPOUSUARIO:"+NOM_TIPOUSUARIO.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cSGMUTIPOUSUARIO;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cSGMUTIPOUSUARIO;"
					+"ID_TIPOUSUARIO:"+ID_TIPOUSUARIO.ToString()+";"
					+"NOM_TIPOUSUARIO:"+NOM_TIPOUSUARIO.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cSGMUTIPOUSUARIO;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cSGMUTIPOUSUARIO;"
					+"ID_TIPOUSUARIO:"+ID_TIPOUSUARIO.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cSGMUTIPOUSUARIO;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
