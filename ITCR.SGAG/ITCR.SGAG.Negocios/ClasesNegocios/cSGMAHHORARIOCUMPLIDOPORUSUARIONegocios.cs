...
// Proyecto: ITCR.SGAG
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'SGMAHHORARIOCUMPLIDOPORUSUARIO'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'SGMAHHORARIOCUMPLIDOPORUSUARIO'.
	/// </summary>
	public class cSGMAHHORARIOCUMPLIDOPORUSUARIONegocios : cSGMAHHORARIOCUMPLIDOPORUSUARIODatos
	{
		...
		/// </summary>
		public cSGMAHHORARIOCUMPLIDOPORUSUARIONegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cSGMAHHORARIOCUMPLIDOPORUSUARIO;"
					+"FK_IDHORARIOPORUSUARIO:"+FK_IDHORARIOPORUSUARIO.ToString()+";"
					+"FK_IDHORARIOCUMPLIDO:"+FK_IDHORARIOCUMPLIDO.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cSGMAHHORARIOCUMPLIDOPORUSUARIO;"+ex.Message;
