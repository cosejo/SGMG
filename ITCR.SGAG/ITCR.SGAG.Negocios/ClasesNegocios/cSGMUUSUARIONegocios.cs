...
// Proyecto: ITCR.SGAG
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'SGMUUSUARIO'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'SGMUUSUARIO'.
	/// </summary>
	public class cSGMUUSUARIONegocios : cSGMUUSUARIODatos
	{
		...
		/// </summary>
		public cSGMUUSUARIONegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cSGMUUSUARIO;"
					+"NOM_USUARIO:"+NOM_USUARIO.ToString()+";"
					+"CON_USUARIO:"+CON_USUARIO.ToString()+";"
					+"CAR_USUARIO:"+CAR_USUARIO.ToString()+";"
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cSGMUUSUARIO;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cSGMUUSUARIO;"
					+"NOM_USUARIO:"+NOM_USUARIO.ToString()+";"
					+"CON_USUARIO:"+CON_USUARIO.ToString()+";"
					+"CAR_USUARIO:"+CAR_USUARIO.ToString()+";"
					+"FK_IDTIPOUSUARIO:"+FK_IDTIPOUSUARIO.ToString()+";";
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cSGMUUSUARIO;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cSGMUUSUARIO;"
					+"CAR_USUARIO:"+CAR_USUARIO.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cSGMUUSUARIO;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
