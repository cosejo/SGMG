...
// Proyecto: ITCR.SGAG
// Descripción: Clase de LOGICA DE NEGOCIOS para tabla 'SGMHHORARIOPORUSUARIO'
...
{
	/// <summary>
	/// Propósito: Clase de lógica de negocios para tabla 'SGMHHORARIOPORUSUARIO'.
	/// </summary>
	public class cSGMHHORARIOPORUSUARIONegocios : cSGMHHORARIOPORUSUARIODatos
	{
		...
		/// </summary>
		public cSGMHHORARIOPORUSUARIONegocios(int COD_APLICACIONBitacora, string COD_SEDEBitacora, int COD_FUNCIONALIDADBitacora, string ID_USUARIOBitacora) : base()
		{
		...
		public override bool Insertar()
		{
			...
			try
			{
				...
				operacion = "Insertar cSGMHHORARIOPORUSUARIO;"
					+"FK_IDHORARIO:"+FK_IDHORARIO.ToString()+";"
					+"FK_CARUSUARIO:"+FK_CARUSUARIO.ToString()+";";
			...
			catch (Exception ex)
			{
				...
				operacion = "Error Insertar cSGMHHORARIOPORUSUARIO;"+ex.Message;
		...
		public override bool Actualizar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Actualizar cSGMHHORARIOPORUSUARIO;"
					+"FK_IDHORARIO:"+FK_IDHORARIO.ToString()+";"
					+"FK_CARUSUARIO:"+FK_CARUSUARIO.ToString()+";"
					+"ID_HORARIOPORUSUARIO:"+ID_HORARIOPORUSUARIO.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Actualizar cSGMHHORARIOPORUSUARIO;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
		...
		public override bool Eliminar()
		{
			...
			{
				//Construir aqui el string a guardar en la bitacora.
				operacion = "Eliminar cSGMHHORARIOPORUSUARIO;"
					+"ID_HORARIOPORUSUARIO:"+ID_HORARIOPORUSUARIO.ToString()+";";
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.UsoFuncionalidad, _ID_USUARIOBitacora,operacion);
			...
			{
				//Construir el string a guardar en la bitácora en caso de error.
				operacion = "Error Eliminar cSGMHHORARIOPORUSUARIO;"+ex.Message;
				//wsseg.BitacoraRegistrarUso(_COD_APLICACIONBitacora, _COD_FUNCIONALIDADBitacora, _COD_SEDEBitacora, eTipoEventoBitacora.Error, _ID_USUARIOBitacora,operacion);
				throw ex;
			}
		}
